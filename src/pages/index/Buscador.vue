<template>
    <div class="wave">
      <div class="wrapper" style="height: 90vh">
        <section class="col">
          <h3>Buscador</h3> é um sistema que permite rastrear o envio e
          recebimento de alguns tipos de informação pela internet.
        ...
        <div class="col justify-center content-center">
            <img src="~assets/buscador.png" style="max-height: 400px;" class="imagem" alt="login-image">
        </div>
        <!-- <div class="flex justify-center content-center">
          <img
            alt="Tecnologia conectada"
